/*
 * Example libpekin_config.h file
 */

#ifndef LIBPEKIN_LIBPEKIN_CONFIG_H_
#define LIBPEKIN_LIBPEKIN_CONFIG_H_
...
//
#endif /* LIBPEKIN_LIBPEKIN_CONFIG_H_ */
